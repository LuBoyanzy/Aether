...
//go:generate fetchsmartctl -out ./smartmontools/smartctl.exe -url https://static.aether.dev/bin/smartctl/smartctl-nc.exe -sha 3912249c3b329249aa512ce796fd1b64d7cbd8378b68ad2756b39163d9c30b47
...
func (sm *SmartManager) CollectSmart(deviceInfo *DeviceInfo) error {
	...
	// NVMe controllers (/dev/nvme0) don't always support SMART queries. See aether/issues/1504
...
func (sm *SmartManager) smartctlArgs(deviceInfo *DeviceInfo, includeStandby bool) []string {
	...
	if deviceInfo != nil {
		...
		// types sometimes misidentified in scan; see aether/issues/1345
