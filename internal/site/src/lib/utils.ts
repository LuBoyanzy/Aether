 ...
 * @example
 * // Assuming system.host is "/var/run/aether.sock"
 * const hostname = getHostDisplayValue(system) // hostname will be "aether.sock"
 */
...
/** Get the hub URL from the global AETHER object */
export const getHubURL = () => globalThis.AETHER?.HUB_URL || window.location.origin
