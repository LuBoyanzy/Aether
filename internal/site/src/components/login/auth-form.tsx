...
import { BRAND_NAME, cn, showDocsUnavailable } from "@/lib/utils"
		...
		async (e: React.FormEvent<HTMLFormElement>) => {
			...
			try {
				...
				if (isFirstRun) {
					...
					await pb.send("/api/aether/create-user", {
						method: "POST",
				...
				<Dialog>
					...
					<DialogContent style={{ maxWidth: 440, width: "90%" }}>
						...
						<div className="text-primary/70 text-[0.95em] contents">
							<p>{BRAND_NAME} supports OpenID Connect and many OAuth2 authentication providers.</p>
							<p>
								<button
									type="button"
